...
public class Utils
{
	// rotate a point (x, y) around the center (u, v) with an angle
	public static PointF rotatiePnt(double u, double v, double x, double y, double ang)
	{
	...
	// point line distance
	public static float distToPoint(PointF A, PointF B, PointF pnt)
	{
